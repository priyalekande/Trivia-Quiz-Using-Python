...
from urllib.request import urlopen #helps us to access the url
import json #db is in json format
import pandas as pd
import random 
import ssl 
import certifi
...
with urlopen("https://opentdb.com/api.php?amount=50&category=18&difficulty=medium&type=multiple", context=ssl.create_default_context(cafile=certifi.where())) as webpage:
